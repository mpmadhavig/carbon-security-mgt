...
package org.wso2.carbon.security.mgt.keystore.dao.impl;

import org.wso2.carbon.database.utils.jdbc.NamedPreparedStatement;
import org.wso2.carbon.security.mgt.SecurityConfigException;
import org.wso2.carbon.security.mgt.keystore.dao.DAOUtils;
...
import org.wso2.carbon.security.mgt.util.KeyStoreDatabaseUtil;
import org.wso2.carbon.security.mgt.keystore.dao.constants.PubCertDAOConstants;
import org.wso2.carbon.security.mgt.keystore.dao.constants.PubCertDAOConstants.PubCertTableColumns;
...
public class PubCertDAOImpl extends PubCertDAO {
    ...
    public PubCertDAOImpl(int tenantId) throws SecurityConfigException {
        super(tenantId);
        this.tenantUUID = DAOUtils.getTenantUUID(tenantId);
    }
